        ...
        <table class="providerTable" cellpadding="0" cellspacing="0">
            ...
            <c:forEach var="b" items="${pageInfo.list}">
                <tr>
                    ...
                    <td>
                        <a href="/toupdate?id=${b.id}"><img src="/img/xiugai.png" alt="修改" title="修改"/></a>
                        <a href="javascript:void(0);" class="removeClass"><img src="/img/schu.png" alt="删除" title="删除"/></a>
                    </td>
                </tr>
            </c:forEach>
        </table>
